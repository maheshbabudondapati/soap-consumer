package com.example.soapconsumer.encoding;
...
public class Jaxb2SoapEncoder implements Encoder<Object> {
    ...
    private Flux<DataBuffer> encode(Object value ,
        ...
        return Mono.fromCallable(() -> {
            ...
            try {
                SoapRequest customerRequest = (SoapRequest) value;

                OutputStream outputStream = buffer.asOutputStream();
                Class<?> clazz = ClassUtils.getUserClass(customerRequest);
                ...
                marshaller.marshal(customerRequest, message.getPayloadResult());
